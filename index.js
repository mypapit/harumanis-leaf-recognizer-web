const CLASS_LABEL = Array("antrachnose", "background","black soothy mold","healthy");
...
function classifyImage() {
  tensor = tf.browser
    ...
    .toFloat().expandDims().div(tf.scalar(255));
...
function ddx() {
  if (navigator.share) {
    navigator
      .share({
        title: "Mango Leaf Disease Recognizer",
        text: "Compact Neural network for detecting leaf disease",
